            ...
            <div className="bg-card border border-border rounded-lg shadow-lg w-full max-w-[25rem] mx-4">
                <div className="flex items-center justify-between p-4 border-b border-border">
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="group relative flex h-4 w-4 items-center justify-center rounded-full bg-error shadow-sm transition-all duration-200 ease-out hover:scale-125 active:scale-95"
                    >
                        <X
                            size={10}
                            strokeWidth={3}
                            className="text-foreground opacity-0 transition-opacity duration-200 group-hover:opacity-100"
                        />
                    </button>
                </div>
