...
export default function Alert({ type, message, title, duration = 3000, onClose }: AlertProps) {
    const styles = useMemo(() => {
        const baseColors = {
            success: {
                text: 'text-[#3AB354]',
                bg: 'bg-[#3AB354]/10',
                badge: 'bg-[#3AB354]/20 text-[#3AB354] dark:text-[#3AB354]',
                border: 'border-[#3AB354]/30',
            },
            error: {
                text: 'text-[#B33A3A]',
                bg: 'bg-[#B33A3A]/10',
                badge: 'bg-[#B33A3A]/20 text-[#B33A3A] dark:text-[#B33A3A]',
                border: 'border-[#B33A3A]/30',
            },
            warning: {
                text: 'text-[#C6971E]',
                bg: 'bg-[#C6971E]/10',
                badge: 'bg-[#C6971E]/20 text-[#C6971E] dark:text-[#C6971E]',
                border: 'border-[#C6971E]/30',
            },
            info: {
                text: 'text-[#4670B4]',
                bg: 'bg-[#4670B4]/10',
                badge: 'bg-[#4670B4]/20 text-[#4670B4] dark:text-[#4670B4]',
            ...
            case 'success':
                return (
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="#3AB354"
                        className="icon icon-tabler icons-tabler-filled icon-tabler-mood-happy"
                    >
            ...
            case 'error':
                return (
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="#B33A3A"
                        className="icon icon-tabler icons-tabler-filled icon-tabler-mood-angry"
                    >
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            case 'info':
                return (
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="#4670B4"
                        className="icon icon-tabler icons-tabler-filled icon-tabler-mood-neutral"
                    >
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <div className="group relative inline-flex items-center justify-center rounded-full shadow-lg backdrop-blur-sm slide-in-from-right">
            ...
            />
            <div
                className={`relative flex items-center gap-2 p-1 pe-2 ${styles.text} ${styles.bg} rounded-full`}
            >
                {getLabel()}
