            ...
            <div className="p-6 space-y-6">
                ...
                <div className="space-y-3">
                    <div className="flex flex-wrap gap-3">
                        <Select
                            value={method}
                            onValueChange={(v: string) => onMethodChange(v as HttpMethod)}
                        >
                            <SelectTrigger
                                className={`bg-secondary ${httpRequest.find((item) => item.method === method)?.border}`}
                            >
                                <SelectValue
                                    className={`${httpRequest.find((item) => item.method === method)?.color} font-semibold`}
                                />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        >
                            {isLoading ? (
                                <EllipsisIcon stroke="white" size={20} />
                            ) : (
                                <SendHorizonal stroke="white" size={20} />
                            )}
                        </Button>
                        <Button
                            onClick={onSave}
